 ...
 const handleSubmit = async (e) => {
  ...
  try {
    const res = await axios.post(
      "https://hrms-backend-1we9.onrender.com/api/credit-heads/create",
      creditHeadData
    );

    console.log("Response:", res.data);
    alert("Credit Head submitted successfully!");
    ...
    console.error("Error submitting Credit Head:", error);
    alert("Failed to submit Credit Head");
  }
};
        ...
        <div className="col-md-8">
          <div className="card shadow-lg">
            <div className="card-header bg-primary text-white">
              <h4 className="mb-0">Credit Head Form</h4>
            </div>
